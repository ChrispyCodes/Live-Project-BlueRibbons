...
namespace BlueRibbonsReview.Controllers
{
    public class CampaignsController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string searchString)
        {
            ...
            var campaigns = db.Campaigns.Where(c => c.OpenCampaign == true && DateTime.Today < c.ExpireDate || c.ExpireDate == null);
        ...
        public ActionResult Landing()
        {
            ...
            // Creates an object from the dB made of soon-to-expire campaigns.
            var expiringCampaigns = db.Campaigns.Where(c => DateTime.Today < c.ExpireDate && datePlusSeven > c.ExpireDate && c.ExpireDate != null && c.OpenCampaign == true);
            
                // If there are ZERO expiring, then populate it with all campaigns that are both open and not past their ExpireDate.
                ViewBag.test = "Check out these deals before they expire!";
                if (expiringCampaigns.ToList().Count == 0)
                {
                expiringCampaigns = db.Campaigns.Where(c => c.OpenCampaign == true && (c.ExpireDate > DateTime.Today || c.ExpireDate == null));
                    ViewBag.test = "Check out all our deals!";
        ...
        public ActionResult EditAdmin([Bind(Include = "CampaignID,ASIN,Name,ImageUrL,Description,RetailPrice,SalePrice,StartDate,CloseDate,ExpireDate,VendorsPurchaseInstructions")]int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        // POST: Campaigns/AdminView/EditAdmin
        ...
        public ActionResult GetLandingPartial()
        {
            ...
            var expiringCampaigns = db.Campaigns.Where(c => DateTime.Today < c.ExpireDate && datePlusSeven > c.ExpireDate && c.ExpireDate != null);
